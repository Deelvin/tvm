...
from models import get_cpu_info
...
parser.add_argument("--onnx-model", required=True, help="optional, reference to the onnx DLRM model", default='')
...
parser.add_argument("--batch-size", help="optional, batch size for the model", default=1)
...
shape_dict = getInput(onnx_model)
...
del onnx_model
target, target_host = get_cpu_info()
tasks, task_weights = auto_scheduler.extract_tasks(
    mod["main"], params, target=target, target_host=target_host, include_simple_tasks = False, opt_level=2)
