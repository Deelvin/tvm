...
def main():
    ...
    time_per_item_sec = run_dur / num_iter / batch
    mega_item_per_sec = int(1 / time_per_item_sec)
    
    g_mod.module["print_statistic"]()

    print(f"Time per item : {time_per_item_sec * 1000000} us")
    print(f"MIPS : {mega_item_per_sec}")
