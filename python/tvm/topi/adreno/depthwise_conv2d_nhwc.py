...
def depthwise_conv2d_nhwc(cfg, Input, Filter, stride, padding, dilation, out_dtype):
    compute_depthwise_conv2d_nhwc(cfg, Input, Filter, stride, padding, dilation, out_dtype, 4)

def compute_depthwise_conv2d_nhwc(cfg, Input, Filter, stride, padding, dilation, out_dtype, default_block_size):
    """
