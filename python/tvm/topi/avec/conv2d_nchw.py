...
@autotvm.register_topi_compute("conv2d_nchwc.avec")
...
@autotvm.register_topi_compute("conv2d_nchwc_acc32.avec")
...
@autotvm.register_topi_schedule("conv2d_nchwc.avec")
def schedule_conv2d_nchwc(cfg, outs):
    return schedule_conv2d_nchwc_impl(cfg, outs, tag="cast_from_acc16")


@autotvm.register_topi_schedule("conv2d_nchwc_acc32.avec")
